...
-- ====================================================================
	...
	AddItemBag(BAG_MONSTER, 0,561,'Monster_(561)_Medusa') -- DropFunction /2/ used when OverriteDefaultSettings from IGC_MonsterGroupRegen.xml is set to 0

-- ====================================================================
-- EventBags -- BagType, EventID, 0, 'FileName'
-- ====================================================================
	AddItemBag(BAG_EVENT, 1, 0, 'Buff_Gladiators_Drop') -- DropFunction /3/
	AddItemBag(BAG_EVENT, 2, 0, 'Event_IllusionTemple_(1-2)_Monsters') -- DropFunction /3/
	AddItemBag(BAG_EVENT, 3, 0, 'Event_IllusionTemple_(3-4)_Monsters') -- DropFunction /3/
	AddItemBag(BAG_EVENT, 4, 0, 'Event_IllusionTemple_(5-6)_Monsters') -- DropFunction /3/
...
-- Bags for purpose of Monster Group Regen System
	AddItemBag(BAG_EVENT, 150,0, 'Event_Monster_(561)_Medusa') -- DropFunction /3/ used when OverriteDefaultSettings from IGC_MonsterGroupRegen.xml is set to 1
	AddItemBag(BAG_EVENT, 151,0, 'Event_Monster_(560)_Sapi_Queen') -- DropFunction /3/ used when OverriteDefaultSettings from IGC_MonsterGroupRegen.xml is set to 1
end
...
function CommonBagItemDrop(aIndex, MapNumber, X, Y)
	...
	CreateItem(aIndex, MapNumber, X, Y, ItemID, ItemLevel, ItemDur, IsSkill, IsLuck, IsOption, aIndex, IsExc, IsAncient, 0, IsSocket)
	return 1
end
...
function MonsterBagItemDrop(MonsterIndex, MapNumber, MonsterX, MonsterY, PlayerIndex)
	...
	CreateItem(MonsterIndex, MapNumber, MonsterX, MonsterY, ItemID, ItemLevel, ItemDur, IsSkill, IsLuck, IsOption, PlayerIndex, IsExc, IsAncient, 0, IsSocket)
	return 1
end
...
function EventBagMakeItem()
	...
	return ItemLevel, ItemDur, IsSkill, IsLuck, IsOption, IsExc, IsAncient, IsSocket
end