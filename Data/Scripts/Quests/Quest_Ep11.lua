...
[ Version ] 0.0.0.1
[ Text ]    Master Skill Tree Reset Quest (Third)
[ Desc ]                                    
--]]
--================================================================================================================
...
function Ep11_Complete(objIndex)
	...
	if QS == 2 then
		...
		LuaQuestClass.SendQuestComplete(Ep11, QS, objIndex)--When the confirm button is pressed without in-progress reward.
		return
	elseif QS == 5 then
		LuaQuestClass.SetQuestSwitch(Ep11, 3, objIndex)
		LuaQuestClass.SendQuestComplete(Ep11, QS, objIndex)--When the confirm button is pressed without in-progress reward.
	...
	local bComplete = LuaQuestClass.IsQuestComplete(Ep11, objIndex)--Completion check
