...
function Ep16_Complete(objIndex)
	...
	if QS == 1 then
		...
		LuaQuestClass.SendQuestComplete(Ep16, QS, objIndex)--When the confirm button is pressed without in-progress reward.
		return
	elseif QS == 4 then
	...
	local bComplete = LuaQuestClass.IsQuestComplete(Ep16, objIndex)--Completion check
