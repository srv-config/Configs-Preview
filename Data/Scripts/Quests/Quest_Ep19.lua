...
function Ep19_Complete(objIndex)
	...
	if QS == 1 then
		LuaQuestClass.SetQuestSwitch( Ep19, 0, objIndex)
		LuaQuestClass.SendQuestComplete( Ep19, QS, objIndex)--When the confirm button is pressed without in-progress reward.
		return
	elseif QS == 4 then
		LuaQuestClass.SetQuestSwitch( Ep19, 3, objIndex)
		LuaQuestClass.SendQuestComplete( Ep19, QS, objIndex)--When the confirm button is pressed without in-progress reward.
	...
	local bComplete = LuaQuestClass.IsQuestComplete( Ep19, objIndex)--Completion check
