...
-- Blood Castle Zone 1: 1st Chain Quest
	if QS == 0 then
...
-- Blood Castle Zone 1: 2nd Chain Quest
	if QS == 9 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 1: 3rd Chain Quest
	if QS == 12 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 1: 4th Chain Quest
	if QS == 15 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 2: 1st Chain Quest
	if QS == 18 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 2: 2nd Chain Quest
	if QS == 27 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 2: 3rd Chain Quest
	if QS == 30 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 2: 4th Chain Quest
	if QS == 33 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 3: 1st Chain Quest
	if QS == 36 then
...
-- Blood Castle Zone 3: 2nd Chain Quest
	if QS == 40 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 3: 3rd Chain Quest
	if QS == 43 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 4: 1st Chain Quest
	if QS == 46 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 4: 2nd Chain Quest
	if QS == 49 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 4: 3rd Chain Quest
	if QS == 52 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 5: 1st Chain Quest
	if QS == 55 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 5: 2nd Chain Quest
	if QS == 58 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 5: 3rd Chain Quest
	if QS == 61 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 6: 1st Chain Quest
	if QS == 64 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 6: 2nd Chain Quest
	if QS == 67 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 6: 3rd Chain Quest
	if QS == 70 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 7: 1st Chain Quest
	if QS == 73 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 7: 2nd Chain Quest
	if QS == 76 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 7: 3rd Chain Quest
	if QS == 79 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 8: 1st Chain Quest
	if QS == 82 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 8: 2nd Chain Quest
	if QS == 85 then
		if SelectSyntactic == 1 then-- What is it?
...
-- Blood Castle Zone 8: 3rd Chain Quest
	if QS == 88 then
		if SelectSyntactic == 1 then-- What is it?
...
function Ep3_Complete(objIndex)
	...
	if QS == 1 then
		...
		LuaQuestClass.SendQuestComplete(Ep3, QS, objIndex)--When the confirm button is pressed without in-progress reward.
		return
	elseif QS == 10 then
		LuaQuestClass.SetQuestSwitch(Ep3, 9, objIndex)
		LuaQuestClass.SendQuestComplete(Ep3, QS, objIndex)--When the confirm button is pressed without in-progress reward.
	...
	local bComplete = LuaQuestClass.IsQuestComplete(Ep3, objIndex)--Completion check
