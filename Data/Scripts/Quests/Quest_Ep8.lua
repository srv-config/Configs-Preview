...
function Ep8_Progress(SelectSyntactic, objIndex)
	...
	if QS == 0 then-- Tutorial Quest (Description)
		if SelectSyntactic == 1 then-- Derubish introduction
			LuaQuestClass.SendQuestProgress(Ep8, 1, objIndex)-- 
			return
		end
	end
	if QS == 1 then
		if SelectSyntactic == 1 then-- Beware of element monsters
			LuaQuestClass.SendQuestProgress(Ep8, 2, objIndex)-- 
			return
		end
	end
	if QS == 2 then
		if SelectSyntactic == 1 then-- Element monster description
			LuaQuestClass.SendQuestProgress(Ep8, 3, objIndex)-- 
			return
		end
	end
	if QS == 3 then
		if SelectSyntactic == 1 then-- Get me a Pentagram
	...
	if QS == 6 then
		if SelectSyntactic == 1 then-- Pentagram attributes
			LuaQuestClass.SendQuestProgress(Ep8, 7, objIndex)-- 
			return
		end
	end
	if QS == 7 then
		if SelectSyntactic == 1 then-- Element description
			LuaQuestClass.SendQuestProgress(Ep8, 8, objIndex)-- 
			return
		end
	end
	if QS == 8 then
		if SelectSyntactic == 1 then-- Catch Devil Fairies for me
	...
	if QS == 11 then
		if SelectSyntactic == 1 then-- Element gem description
			LuaQuestClass.SendQuestProgress(Ep8, 12, objIndex)-- 
			return
		end
	end
	if QS == 12 then
		if SelectSyntactic == 1 then-- Element window description
			LuaQuestClass.SendQuestProgress(Ep8, 13, objIndex)-- 
			return
		end
	end
	if QS == 13 then
		if SelectSyntactic == 1 then-- Equip/unequip element gem
			LuaQuestClass.SendQuestProgress(Ep8, 14, objIndex)-- 
			return
		end
	end
	if QS == 14 then
		if SelectSyntactic == 1 then-- Get me Mithril
	...
	if QS == 17 then
		if SelectSyntactic == 1 then-- Get me a Talisman
	...
	if QS == 20 then
		if SelectSyntactic == 1 then-- Element gem combination
			LuaQuestClass.SendQuestProgress(Ep8, 21, objIndex)-- 
			return
		end
	end
	if QS == 21 then
		if SelectSyntactic == 1 then-- Element gem upgrade
			LuaQuestClass.SendQuestProgress(Ep8, 22, objIndex)-- 
			return
		end
	end
	if QS == 22 then
		if SelectSyntactic == 1 then-- Additional upgrade
			LuaQuestClass.SendQuestProgress(Ep8, 23, objIndex)-- 
			return
		end
	end
	if QS == 23 then
		if SelectSyntactic == 1 then-- Rank description
			LuaQuestClass.SendQuestProgress(Ep8, 24, objIndex)-- 
			return
		end
	end
	if QS == 24 then
		if SelectSyntactic == 1 then-- Kill Elemental Beasts for me
...
-- Hunting Ground 1 Quest
	if QS == 27 then
		if SelectSyntactic == 1 then-- Kill Devil Fairies for me
	...
	if QS == 33 then
		if SelectSyntactic == 1 then-- Kill Elemental Knights for me
...
-- Hunting Ground 2 Quest
	if QS == 36 then
		if SelectSyntactic == 1 then-- Kill Ubaid Devil Fairies for me
	...
	if QS == 39 then
		if SelectSyntactic == 1 then-- Kill Ubaid Elemental Beasts for me
	...
	if QS == 42 then
		if SelectSyntactic == 1 then-- Kill Ubaid Elemental Knights for me
...
-- Hunting Ground 1 Repeatable Quest
	if QS == 45 then
		if SelectSyntactic == 1 then-- Kill Devil Fairies for me
...
-- Hunting Ground 2 Repeatable Quest
	if QS == 54 then
		if SelectSyntactic == 1 then-- Kill Ubaid Devil Fairies for me
...
function Ep8_Complete(objIndex)
	...
	if QS == 4 then
		...
		LuaQuestClass.SendQuestComplete(Ep8, QS, objIndex)--When the confirm button is pressed without in-progress reward.
		return
	elseif QS == 9 then
	...
	local bComplete = LuaQuestClass.IsQuestComplete(Ep8, objIndex)--Completion check
