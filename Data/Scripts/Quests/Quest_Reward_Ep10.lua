...
[ Version ] 0.0.0.2
[ Text ]    Fix: quest not progressing when declined
[ Line ]    47 - 57                             
--]]
--================================================================================================================
...
LuaQuestClass.SetQuestProgress(ASK1, Ep10, 2)
	...
	LuaQuestClass.SetQuestDropItem(Ep10, 1, ASK1, 557, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)-- Saffy Queen
	
	ItemType = 13 ItemIndex = 149 ItemLevel = 0 ItemSkill = 0 ItemCnt = 10 Opt = 0 ExOpt = 0
	LuaQuestClass.SetQuestGetItem(ASK1, Ep10, 1, ItemType, ItemIndex, ItemLevel, ItemSkill, ItemCnt, Opt, ExOpt)-- 10 Blue Ink
...
LuaQuestClass.SetQuestProgress(ASK1, Ep10, 5)   
	...
	LuaQuestClass.SetQuestDropItem(Ep10, 4, ASK1, 562, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)-- Dark Mammoth
	
	ItemType = 13 ItemIndex = 151 ItemLevel = 0 ItemSkill = 0 ItemCnt = 1 Opt = 0 ExOpt = 0
	LuaQuestClass.SetQuestGetItem(ASK1, Ep10, 4, ItemType, ItemIndex, ItemLevel, ItemSkill, ItemCnt, Opt, ExOpt)-- Mental Parchment
	
	ItemType = 13 ItemIndex = 157 ItemLevel = 0 dur = 0 ItemSkill = 0 ItemCnt = 1 
	LuaQuestClass.SetQuestRewardItem(Ep10, 4, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)-- Sealed Blue Scroll of Oblivion
end
--================================================================================================================  
