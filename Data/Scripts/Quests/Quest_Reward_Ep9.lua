...
LuaQuestClass.SetQuestProgress(ASK1, Ep9, 2)
	...
	LuaQuestClass.SetQuestDropItem(Ep9, 1, ASK1, 553, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)-- Berserker Warrior
	
	ItemType = 13 ItemIndex = 148 ItemLevel = 0 ItemSkill = 0 ItemCnt = 10 Opt = 0 ExOpt = 0
	LuaQuestClass.SetQuestGetItem(ASK1, Ep9, 1, ItemType, ItemIndex, ItemLevel, ItemSkill, ItemCnt, Opt, ExOpt)-- 10 Green Ink
...
LuaQuestClass.SetQuestProgress(ASK1, Ep9, 5)    
	...
	LuaQuestClass.SetQuestDropItem(Ep9, 4, ASK1, 562, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)-- Dark Mammoth
	
	ItemType = 13 ItemIndex = 151 ItemLevel = 0 ItemSkill = 0 ItemCnt = 1 Opt = 0 ExOpt = 0
	LuaQuestClass.SetQuestGetItem(ASK1, Ep9, 4, ItemType, ItemIndex, ItemLevel, ItemSkill, ItemCnt, Opt, ExOpt)-- Mental Parchment
	
	ItemType = 13 ItemIndex = 156 ItemLevel = 0 dur = 0 ItemSkill = 0 ItemCnt = 1 
	LuaQuestClass.SetQuestRewardItem(Ep9, 4, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)-- Sealed Green Scroll of Oblivion
end
--================================================================================================================