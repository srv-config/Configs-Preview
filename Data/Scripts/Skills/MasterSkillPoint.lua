...
function MLS_ValueInit()
	MLS.AddToMLSTable(1, 'FN_LuaGetPercent', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(2, 'FN_LuaGetPercent2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(3, 'FN_LuaGetSkillDamageMin', MLST_VALUE_DAMAGE) -- 1 
	MLS.AddToMLSTable(4, 'FN_LuaGetSkillDamageMiddle', MLST_VALUE_DAMAGE) -- 1
	MLS.AddToMLSTable(5, 'FN_LuaGetSkillDamageMax', MLST_VALUE_DAMAGE) -- 1
	MLS.AddToMLSTable(6, 'FN_LuaGetMonsterKill', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(7, 'FN_LuaGetPercent3', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(8, 'FN_LuaGetMaxAG', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(9, 'FN_LuaGetMaxLifeMana', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(10, 'FN_LuaGetAttack', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(11, 'FN_LuaGetSDMonsterKill', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(12, 'FN_LuaGetBlockingRate', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(13, 'FN_LuaGetAttackSuccessRate', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(14, 'FN_LuaGetManAttackRate', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(15, 'FN_LuaGetPercent4', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(16, 'FN_LuaGetIncreaseBlocking', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(17, 'FN_LuaGetIncreaseStat', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(18, 'FN_LuaGetDecreaseMana', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(19, 'FN_LuaGetChangeBlocking', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(20, 'FN_LuaGetControlAttack', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(21, 'FN_LuaGetManaIncRate', MLST_VALUE_MANA_INC) -- 2
	MLS.AddToMLSTable(22, 'FN_LuaGetSkillDamageMin2', MLST_VALUE_DAMAGE) -- 1
	MLS.AddToMLSTable(23, 'FN_LuaGetAttackSpeed', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(24, 'FN_LuaGetPercent5', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(25, 'FN_LuaGetBloodStorm', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(26, 'FN_LuaGetEarthPrison', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(27, 'FN_LuaGetPoisonArrow', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(28, 'FN_LuaGetIronDefense', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(29, 'FN_LuaGetBlockingRate_2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(30, 'FN_LuaGetAttackRate_2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(31, 'FN_LuaGetManAttack_2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(32, 'FN_LuaGetMaxSD_1', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(33, 'FN_LuaGetMaxSD_2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(34, 'FN_LuaGetMaxLifeMana_2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(35, 'FN_LuaGetIncBlocking_2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(36, 'FN_LuaGetIncStat_2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(37, 'FN_LuaGetMaxAG_2', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(38, 'FN_LuaGetRate_6', MLST_VALUE_NORMAL) -- 0
	MLS.AddToMLSTable(39, 'FN_LuaGetRate_7', MLST_VALUE_NORMAL) -- 0
end
